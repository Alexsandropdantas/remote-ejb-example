...
public class EjbRemoteClient {
	...
	public static void main(String[] args) {
		...
		String host = "wildfly-rota-alexsandro-ear-ejb.apps.ocp.sefaz.pe.gov.br";   //"127.0.0.1";
		String port = "80"; // Wildfly HTTP port
...
//		String port = "8080"; // Wildfly HTTP port
		...
		//String ejbUrl = "java:global/ejb-remote-server/ExampleServiceImpl";
	...
	private static Context createRemoteEjbContext(String host, String port) throws NamingException {
		...
		props.put(INITIAL_CONTEXT_FACTORY, "org.wildfly.naming.client.WildFlyInitialContextFactory");
...
//		props.put("remote.connection.default.connect.options.org.xnio.Options.SASL_POLICY_NOANONYMOUS", false);
		...
		props.put(PROVIDER_URL, "https://" + host + "/wildfly-services");
